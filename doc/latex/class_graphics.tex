...
The game width. 
\end{DoxyReturn}
\hypertarget{class_graphics_afacc722603c661f667d0fcfd43f7ab5c}{\index{Graphics@{Graphics}!get\-Renderer@{get\-Renderer}}
...
\begin{DoxyReturn}{Returns}
Pointer to the default renderer. 
\end{DoxyReturn}
\hypertarget{class_graphics_ab70377438ad3cd1a77fa5d802c7eb324}{\index{Graphics@{Graphics}!get\-Transition@{get\-Transition}}
\index{get\-Transition@{get\-Transition}!Graphics@{Graphics}}
\subsubsection[{get\-Transition}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Transition} $\ast$ Graphics\-::get\-Transition (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{class_graphics_ab70377438ad3cd1a77fa5d802c7eb324}
...
\end{DoxyReturn}
\hypertarget{class_graphics_a3eb162b89e24962a946bc40e708dd0a0}{\index{Graphics@{Graphics}!set\-Transition@{set\-Transition}}
\index{set\-Transition@{set\-Transition}!Graphics@{Graphics}}
\subsubsection[{set\-Transition}]{\setlength{\rightskip}{0pt plus 5cm}void Graphics\-::set\-Transition (
\begin{DoxyParamCaption}
\item[{{\bf Transition} $\ast$}]{t}
\end{DoxyParamCaption}
)}}\label{class_graphics_a3eb162b89e24962a946bc40e708dd0a0}


Make a \hyperlink{class_transition}{Transition} occur instantaniously. 


\begin{DoxyParams}{Parameters}
{\em t} & pointer to a \hyperlink{class_transition}{Transition} to make. \\
\hline
\end{DoxyParams}
...
\hypertarget{class_graphics_a0e96d6ad5fd4a2546c2385f92e2ee12d}{\index{Graphics@{Graphics}!trans@{trans}}
\index{trans@{trans}!Graphics@{Graphics}}
\subsubsection[{trans}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Transition}$\ast$ Graphics\-::trans\hspace{0.3cm}{\ttfamily [protected]}}}\label{class_graphics_a0e96d6ad5fd4a2546c2385f92e2ee12d}


Current transition pointer. 

When N\-U\-L\-L, no transition is taking effect. \hypertarget{class_graphics_af397f61e26b41302b0b66ee4ab408952}{\index{Graphics@{Graphics}!window@{window}}
